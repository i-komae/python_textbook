...
\code{dependencies} に書いた内容は、このパッケージを \code{pip install} したときに一緒に解決される。ここへ列挙したライブラリは、パッケージの実行に必要な依存関係として記録される。
...
README があれば、GitHub や研究室内で共有した際に、導入方法と使用例をリポジトリの入口で確認できる。docstring は関数単位、README はパッケージ全体の説明を担う。
