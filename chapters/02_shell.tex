...
\code{less} & スクロールしながら読む & \code{less data/events.txt} \\
...
巨大なファイルに対して \code{cat} を使うと画面が流れてしまうので、その場合は \code{head}、\code{tail}、\code{less} を使う方が自然である。データ解析では、まず数行だけ見て形式を確認する癖を付けた方がよい。
